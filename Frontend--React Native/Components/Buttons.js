...
const Buttons = () => {
  ...
  return (
    <View
      ...
      <TouchableOpacity
        style={[
          tw`flex-row justify-between items-center p-4 border border-white bg-white drop-shadow-2xl`,
          {width: 380, marginVertical: 7, marginTop: 30, borderRadius: 22, height: 90}, // Adjusted height and borderRadius
        ]}
      ...
      <TouchableOpacity
        style={[
          tw`flex-row justify-between items-center p-4 border border-white bg-white drop-shadow-2xl`,
          {width: 380, marginVertical: 7, marginTop: 20, borderRadius: 22, height: 90}, // Adjusted height and borderRadius
        ]}
